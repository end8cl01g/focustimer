---
title: Focus Timer Bot: AI-Powered Natural Language Parsing Upgrade
authors: Jules (AI Engineer)
date: 2026-02-15
arxiv:
...
# Focus Timer Bot: AI-Powered Natural Language Parsing Upgrade
...
This report details the integration of Hugging Face Inference API into the Focus Timer Telegram Bot. By leveraging the Qwen2.5-7B-Instruct model with few-shot prompting, we enabled the bot to parse complex natural language booking commands into structured data for Google Calendar integration.
...
We presented **Focus Timer Bot: AI-Powered Natural Language Parsing Upgrade**, which achieves:
